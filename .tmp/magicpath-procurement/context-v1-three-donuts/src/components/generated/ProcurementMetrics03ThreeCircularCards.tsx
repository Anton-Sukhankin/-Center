...
function CircularMetric({
  ...
  return <article className="flex h-full min-w-0 items-center gap-3 rounded-xl border border-[#e3e8ef] bg-[#fbfcfe] p-3">
    <div className="relative grid h-[92px] w-[92px] shrink-0 place-items-center rounded-full" style={{ background: `conic-gradient(${color} 0 72%, #e7ebf0 72% 100%)` }} role="img" aria-label={`${label}: 72 процента`}>
      <span className="absolute inset-[10px] rounded-full bg-white" />
      <strong className="relative text-lg font-semibold text-[#111827]">72%</strong>
    </div>
...
function BudgetStructureCircle() {
  return <article className="flex h-full min-w-0 items-center gap-3 rounded-xl border border-[#e3e8ef] bg-[#fbfcfe] p-3">
    <div className="relative grid h-[92px] w-[92px] shrink-0 place-items-center rounded-full" style={{ background: 'conic-gradient(#0b6bff 0 72%, #7c3aed 72% 88%, #d8dee7 88% 100%)' }} role="img" aria-label="Структура покрытия бюджета: 72 процента договоры, 16 процентов открытые тендеры, 12 процентов остаток">
      <span className="absolute inset-[10px] rounded-full bg-white" />
      <span className="relative text-center"><strong className="block text-lg font-semibold leading-none">72%</strong><span className="mt-1 block text-[7px] text-[#667085]">договоры</span></span>
    </div>
    <div className="min-w-0"><p className="text-[10px] font-medium text-[#667085]">Структура покрытия</p><p className="mt-1 text-sm font-semibold">Состояние бюджета</p><div className="mt-2 space-y-1 text-[8px]"><p className="flex items-center gap-1.5"><i className="h-2 w-2 rounded-full bg-[#0b6bff]" /><span className="font-semibold">17,3 млрд ₽</span><span className="text-[#667085]">договоры</span></p><p className="flex items-center gap-1.5"><i className="h-2 w-2 rounded-full bg-[#7c3aed]" /><span className="font-semibold">3,9 млрд ₽</span><span className="text-[#667085]">тендеры</span></p><p className="flex items-center gap-1.5"><i className="h-2 w-2 rounded-full bg-[#d8dee7]" /><span className="font-semibold">2,8 млрд ₽</span><span className="text-[#667085]">остаток</span></p></div></div>
  </article>;
}
