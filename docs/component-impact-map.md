...
| --- | --- | --- | --- | --- | --- |
| `src/data` | Очень высокая | Ленту событий, карточки, детальную карточку, задачи, справочник ответственных, фильтры, активные поверхности шахматки, объекты, финансовые метрики, BI и шапку контекста. | Загрузка страницы, выбор бизнес-юнита/проекта/очереди, создание, редактирование и удаление задач, фильтры, карточки событий, метрики, сводка, объекты, шахматка и BI. Изолированные области проверяются только по прямой команде на восстановление или повторную интеграцию. | `src/data/README.md`, `docs/entity-model.md`, `docs/component-map.md`, `docs/system-compliance-matrix.md`, при будущем требовании — `docs/plans/system-scaling-roadmap.md`. | Высокий |
