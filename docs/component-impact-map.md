...
| Сводка цифровой шахматки | Высокая | Общий header/dropdown, canonical project context, summary data/view-model, sticky KPI-shell, недельную динамику, проблемы, архив, печать, detail-drawer и общий construction-table contract. | Переходы четырех поверхностей; project/queue/BU; project selector bridge; sticky-shell; internal scroll; фильтр проблем; архив/печать/detail; focus trap/return; shared table scroll; cleanup при hide. | `src/features/digital-chessboard-summary/README.md`, `src/components/construction-table/README.md`, `src/data/README.md`, `src/app/README.md`, `docs/reference/digital-chessboard-summary/README.md`, `docs/component-map.md`, `docs/system-compliance-matrix.md`, `docs/plans/digital-chessboard-summary-integration-plan.md`, `design-qa.md`. | Высокий |
