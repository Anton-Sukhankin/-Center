...
function CoverageCard({
  ...
  const tone = accent === 'violet' ? 'bg-[#f3efff] text-[#6d28d9]' : 'bg-[#eaf2ff] text-[#0b6bff]';
  return <div className="rounded-xl border border-[#e3e8ef] bg-[#fbfcfe] p-3">
    <div className="flex items-start justify-between gap-3"><div><p className="text-[10px] font-medium text-[#667085]">{label}</p><p className="mt-1 text-sm font-semibold text-[#111827]">{value}</p></div><span className={`rounded-lg px-2.5 py-1.5 text-base font-semibold ${tone}`}>72%</span></div>
    <p className="mt-2 text-[9px] text-[#667085]">из бюджета {budget}</p>
  </div>;
}
        ...
        <div className="space-y-4 p-5">
          ...
          <section className="rounded-2xl border border-[#e3e8ef] bg-white p-4" aria-label="Контрактация бюджета">
            ...
            <div className="mt-3 grid gap-4 lg:grid-cols-[230px_minmax(0,1fr)]">
              <div className="rounded-xl bg-[#f8fafc] p-3"><p className="text-[10px] text-[#667085]">Общий бюджет закупок</p><p className="mt-1 text-[27px] font-normal leading-none tracking-[-0.03em]">24,0 млрд ₽</p><div className="mt-3 grid grid-cols-2 divide-x divide-[#dfe5ec] rounded-lg bg-white px-2 py-2"><div className="pr-2"><p className="text-[9px] text-[#667085]">Работы</p><p className="mt-1 text-xs font-semibold">14,1 млрд ₽</p></div><div className="pl-2"><p className="text-[9px] text-[#667085]">Материалы</p><p className="mt-1 text-xs font-semibold">9,9 млрд ₽</p></div></div></div>
              <div className="min-w-0"><div className="flex items-end justify-between"><div><p className="text-[10px] text-[#667085]">Структура покрытия бюджета</p><p className="mt-0.5 text-xs font-semibold">Состав общего бюджета по текущему состоянию</p></div><span className="text-[10px] text-[#667085]">24,0 млрд ₽ · 100%</span></div><div className="mt-2 flex h-8 overflow-hidden rounded-lg bg-[#e7ebf0]" aria-label="72 процента договоры, 16 процентов открытые тендеры, 12 процентов остаток"><div className="grid place-items-center bg-[#0b6bff] text-[9px] font-semibold text-white" style={{
                    width: '72%'
                  }}>72%</div><div className="grid place-items-center bg-[#7c3aed] text-[9px] font-semibold text-white" style={{
                    width: '16%'
                  }}>16%</div><div className="grid place-items-center text-[9px] font-semibold text-[#475467]" style={{
                    width: '12%'
                  }}>12%</div></div><div className="mt-2 grid grid-cols-3 gap-2 text-[9px]"><div className="rounded-lg bg-[#eef5ff] px-2 py-1.5"><span className="block font-semibold text-[#0b6bff]">Договоры · 17,3 млрд ₽</span><span className="text-[#667085]">72% бюджета</span></div><div className="rounded-lg bg-[#f5f1ff] px-2 py-1.5"><span className="block font-semibold text-[#6d28d9]">Тендеры · 3,9 млрд ₽</span><span className="text-[#667085]">16% бюджета</span></div><div className="rounded-lg bg-[#f2f4f7] px-2 py-1.5"><span className="block font-semibold text-[#475467]">Остаток · 2,8 млрд ₽</span><span className="text-[#667085]">12% бюджета</span></div></div><div className="mt-3 grid gap-2 sm:grid-cols-2"><CoverageCard label="Законтрактовано работ" value="10,2 млрд ₽" budget="14,1 млрд ₽" /><CoverageCard label="Законтрактовано материалов" value="7,1 млрд ₽" budget="9,9 млрд ₽" accent="violet" /></div></div>
            </div>
          </section>
